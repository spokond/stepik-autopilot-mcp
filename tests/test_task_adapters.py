...
from stepik_autopilot.application.dto import CodeAnswerDTO, CodeReplyDTO, TextAnswerDTO, TextReplyDTO
...
def test_text_and_number_answers_use_text_reply() -> None:
    ...
    assert isinstance(number_reply, TextReplyDTO)
    assert string_reply.text == "answer"
    assert number_reply.text == "0.0000000000001"
